...
2. Clone your fork by using the link: `git clone https://github.com/alex-wang101/Financial-planning-tool.git`
3. Navigate into the project directory using command: `cd Financial-planning-tool`
4. Create new branch for your contribution: git checkout -b feature/your-feature-name
5. Make changes
6. Stage and commit the changes
7. Push branch using `git push origin feature/your-feature-name`
8. Open pull request
